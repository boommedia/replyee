    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#07080f' }}>
      <aside style={{ width: 240, borderRight: '1px solid #1a2035', background: '#0d1018', display: 'flex', flexDirection: 'column', position: 'fixed', top: 0, bottom: 0, left: 0 }}>
        ...
        <div style={{ padding: '16px 20px', borderTop: '1px solid #1a2035' }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: '#e2e8f0', marginBottom: 2 }}>Eric Duffy</div>
          <div style={{ fontSize: 11, color: '#f97316', fontWeight: 700, marginBottom: 12 }}>Super Admin</div>
          <Link href="/dashboard" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: '#64748b', textDecoration: 'none', marginBottom: 8 }}>
            ← Back to Dashboard
          </Link>
