      ...
      <div style={S.card}>
        ...
        {sent ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <h1 style={{ fontSize: 20, fontWeight: 800, color: '#e2e8f0', marginBottom: 10 }}>Check your inbox</h1>
            <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24 }}>
              We sent a password reset link to <strong style={{ color: '#e2e8f0' }}>{email}</strong>
            </p>
            <Link href="/login" style={{ fontSize: 13, color: '#6366f1' }}>← Back to login</Link>
          </div>
        ) : (
          <>
            ...
            <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#64748b' }}>
              Remember it? <Link href="/login" style={{ color: '#6366f1', textDecoration: 'none' }}>Back to login</Link>
            </div>
          </>
        )}
      </div>
